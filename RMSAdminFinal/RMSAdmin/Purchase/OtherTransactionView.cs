...
{
    public partial class OtherTransactionView : Form
    {
        public OtherTransactionView()
        {
            InitializeComponent();
        }
        ...
        private void OtherTransactionView_Load(object sender, EventArgs e)
        {
            StoreDAO aStoreDao = new StoreDAO();
        ...
        {
            List<string> aTransactionList=new List<string>()
                                              {
                                                  "Purchase","Stock Out","Return","Damage"
                                              };

            transactionTypeComboBox.DataSource = aTransactionList;
        }

        private void categoryRadioButton_CheckedChanged(object sender, EventArgs e)
        {
            categorycomboBox.Enabled = categoryRadioButton.Checked;
        }

        private void transactionRadioButton_CheckedChanged(object sender, EventArgs e)
        {
            transactionTypeComboBox.Enabled = transactionRadioButton.Checked;
        }
    }
}
