...
namespace RMSAdmin
{
    public partial class UpdateFoodItemCtl : UserControl
    {
        ...
        public UpdateFoodItemCtl(Int32 itemID)
        {
            ...
            aList.Add("NonFood");
            aList.Add("Otherfood");
            aList.Add("OtherNonfood");

            printareacomboBox.DataSource = aList;
        }
        ...
        private CResult ValidateForm()
        {
            ...
            else
            {
                ...
                bTempFlag = Int32.TryParse(txtOrder.Text.Trim(), out iTempInt);
            ...
            if (!tblCost.Text.Trim().Equals(String.Empty))
            {
                ...
                bTempFlag = Double.TryParse(tblCost.Text.Trim(), out iTempInt1);
                ...
                {
                    oResult.Message = "Please enter table cost, only numbers are allowed.";
            ...
            if (!takeawayCost.Text.Trim().Equals(String.Empty))
            {
                ...
                bTempFlag = Double.TryParse(takeawayCost.Text.Trim(), out iTempInt1);
                ...
                {
                    oResult.Message = "Please enter takeaway cost, only numbers are allowed.";
            ...
            if (!barCost.Text.Trim().Equals(String.Empty))
            {
                ...
                bTempFlag = Double.TryParse(barCost.Text.Trim(), out iTempInt1);
                ...
                {
                    oResult.Message = "Please enter bar Cost, only numbers are allowed.";
