    ...
    namespace Common
    {
        namespace DataAccess
        {
            public abstract class ADatabase
            {
                ...
                public abstract ICategoryAncestorDAO CategoryAnchestor { get; }

                public abstract IReportDAO TotalReport { get; }

                public abstract IInventroySalesReportDAO InventorySalesReport { get; }
