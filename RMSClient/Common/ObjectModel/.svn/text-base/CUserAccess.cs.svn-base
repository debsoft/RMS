...
namespace RMS.Common.ObjectModel
{
    ...
    public class CUserAccess
    {
        ...
        private int m_iProcessTime;
        private int m_iKitchenText;
        ...
        public int ProcessDeliveryTime
        {
            get { return m_iProcessTime; }
            set { m_iProcessTime = value; }
        }

        public int KitchenText
        {
            get { return m_iKitchenText; }
            set { m_iKitchenText = value; }
        }
