...
namespace RMS.Common.ObjectModel
{
    ...
    {         
        ...
        private float m_fTotalDiscount;
        private float m_fTotalDepositePayment;
        private float m_fTotalOtherPayment;
        private float m_fPaymentFoodType;
        private float m_fPaymentNonFoodType;             
        private int m_iTableServedCount;
        private int m_iGuestServedCount;
        ...
        {                      
            ...
            m_fPaymentFoodType = 0;
            m_fPaymentNonFoodType = 0;
            m_iTableServedCount = 0;
            m_iGuestServedCount = 0;
        ...
        {
            get { return m_fTotalDiscount; }
            set { m_fTotalDiscount = value; }
        }
        ...
        public float PaymentFoodType
        {
            get { return m_fPaymentFoodType; }
            set { m_fPaymentFoodType = value; }
        }

        public float  PaymentNonFoodType
        {
            get { return m_fPaymentNonFoodType; }
            set { m_fPaymentNonFoodType = value; }
        }

        public int TableServedCount
        {
            get { return m_iTableServedCount; }
            set { m_iTableServedCount = value; }
        }

        public int GuestServedCount
        {
            get { return m_iGuestServedCount; }
            set { m_iGuestServedCount = value; }
        }
