...
namespace RMS
{
    namespace Common
    {
        public class CCommonConstants
        {
            ...
            private int m_iPrinterPortBaudRate = 9600;
            ...
            private byte[] m_bPrintRedOffCode = { 0x1b, 0x72, 0x48 };//New at 11.06.2009

            private byte[] m_bItalicCodeOn = { 0x1b, 0x34 };
            private byte[] m_bItalicCodeOff = { 0x1b, 0x35 };

            public CCommonConstants() { }


            public byte[] PrintItalicCodeOn
            {
                get { return m_bItalicCodeOn; }
                set { m_bItalicCodeOn = value; }
            }

            public byte[] PrintItalicCodeOff
            {
                get { return m_bItalicCodeOff; }
                set { m_bItalicCodeOff = value; }
            }
