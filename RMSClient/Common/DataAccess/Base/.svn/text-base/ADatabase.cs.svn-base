    ...
    namespace Common
    {
        namespace DataAccess
        {
            public abstract class ADatabase
            {
                ...
                public abstract ISystemManagementDAO SaveDefaultTime { get; }

                public abstract ICustomerInfoDAO ConfiguredTime { get; }

                public abstract ICustomerInfoDAO GetCustomerInfoByName { get; }
                public abstract IGeneralSettingsDAO GeneralSettings { get; }
                public abstract IEFTCardDAO GetEfTcard { get; }
