    ...
    public class CPaymentSummaryDAO : BaseDAO, IPaymentSummaryDAO
    {
        ...
        public CResult GetTotalPaymentForViewReport(DateTime inCurrentDate)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    throw new Exception("Exception occured at GetTotalPaymentSummaryByOrder()", ex);
                }
            }
            finally
            {
        ...
        private CPaymentSummaryByOrder ReaderToPaymentForViewReport(IDataReader oReader)
        {
            ...
            if (oReader["account_pay"] != null)
            {
                oPaymentSummary.TotalAccPayment = float.Parse(oReader["account_pay"].ToString());
            ...
            if (oReader["service_charge_cash"] != null)
            {
                oPaymentSummary.ServiceChargeCash = Convert.ToDouble(oReader["service_charge_cash"]);
            }

            if (oReader["service_charge_eft"] != null)
            {
                oPaymentSummary.ServiceChargeEft = Convert.ToDouble(oReader["service_charge_eft"]);
            }

            if (oReader["service_charge_cheque"] != null)
            {
                oPaymentSummary.ServiceChargeCheque = Convert.ToDouble(oReader["service_charge_cheque"]);
            }

            if (oReader["service_charge_voucher"] != null)
            {
                oPaymentSummary.ServiceChargeVoucher = Convert.ToDouble(oReader["service_charge_voucher"]);
            }

            if (oReader["service_charge_acc"] != null)
            {
                oPaymentSummary.ServiceChargeAcc = Convert.ToDouble(oReader["service_charge_acc"]);
            }
