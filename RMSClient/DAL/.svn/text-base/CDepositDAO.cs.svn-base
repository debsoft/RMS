...
namespace RMS.DataAccess
{
    public class CDepositDAO : BaseDAO, IDepositDAO
    {
        ...
        public CResult InsertDeposit(CDeposit inDeposit)
        {
            ...
            {
                this.OpenConnection();
                string sqlCommand = String.Format(SqlQueries.GetQuery(Query.DepositInsert), inDeposit.DepositBalance, inDeposit.DepositTime, inDeposit.CustomerID, inDeposit.DepositTotalAmount,inDeposit.PcID,inDeposit.Status,inDeposit.DepositType);
        ...
        public CResult UpdateDeposit(CDeposit inDeposit)
        {
            ...
            try
            {
                ...
                sqlCommand = String.Format(SqlQueries.GetQuery(Query.DepositUpdate), inDeposit.DepositBalance, inDeposit.DepositTime, inDeposit.CustomerID, inDeposit.DepositTotalAmount, inDeposit.PcID, inDeposit.Status, inDeposit.DepositType, inDeposit.DepositID);
        ...
        public CResult GetDepositByDepositID(Int64 inDepositID)
        {
            ...
            try
            {
                ...
                this.OpenConnection();
                string sqlCommand = String.Format(SqlQueries.GetQuery(Query.DepositGetByDepositID), inDepositID);
        ...
        public CResult InsertDepositUsed(CDepositUsed inDepositUsed)
        {
            ...
            try
            {
                ...
                this.OpenConnection();
                string sqlCommand = String.Format(SqlQueries.GetQuery(Query.InsertDepositUsed), inDepositUsed.DepositID, inDepositUsed.UsedAmount);
                this.ExecuteNonQuery(sqlCommand);
