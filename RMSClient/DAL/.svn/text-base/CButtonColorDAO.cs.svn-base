...
namespace RMS.DataAccess
{
    public class CButtonColorDAO : BaseDAO, IButtonColorDAO
    {
        ...
        public List<CButtonColor> GetAllButtonColor()
        {
            ...
            {
                this.OpenConnection();
                string sqlCommand = SqlQueries.GetQuery(Query.ButtonColorGetAll);
        ...
        public CButtonColor ButtonColorGetByButtonName(String inButtonName)
        {
            ...
            {
                this.OpenConnection();
                string sqlCommand =String.Format(SqlQueries.GetQuery(Query.ButtonColorByButtonName),inButtonName);
                IDataReader oReader = this.ExecuteReader(sqlCommand);
                if (oReader != null)
                {
                    while (oReader.Read())
