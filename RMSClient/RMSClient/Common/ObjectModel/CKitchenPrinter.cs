...
{
    public class CKitchenPrinter
    {
        private byte[] m_bCutPaperCode;
        private byte[] m_bBeepCode;
        private byte[] m_bBoldOnCode;
        private byte[] m_bBoldOffCode;
        private byte[] m_bDoubleOnCode;
        private byte[] m_bDoubleOffCode;
        private byte[] m_bFontACode;
        private byte[] m_bFontBCode;
        private byte[] m_bDrawerKickCode;
        private byte[] m_bDrawerKick100MSCode;

        public CKitchenPrinter()
        {
            m_bCutPaperCode = null;
            m_bBeepCode = null;
            m_bBoldOnCode = null;
            m_bBoldOffCode = null;
            m_bDoubleOnCode = null;
            m_bDoubleOffCode = null;
            m_bFontACode = null;
            m_bFontBCode = null;
            m_bDrawerKickCode = null;
            m_bDrawerKick100MSCode = null;
        }
