...
{
    public partial class CreditForm : UserControl
    {
        ...
        private void savebutton_Click(object sender, EventArgs e)
        {
            ...
            if (cashamount >= Convert.ToDouble("0" + amounttextBox.Text) && (Convert.ToDouble("0" + amounttextBox.Text) != 0) && (cashamount1 >= Convert.ToDouble("0" + amounttextBox.Text)))
            {
                ...
                string sr = aBankTransactionDao.InsertCreditTransaction(aTransaction);
                MessageBox.Show(sr);
            } else
            {
