     ...
     public class BaseDAO
        {
            ...
            protected IDbConnection GetConnectiObj()
            {
            ...
            protected void OpenConnection(string sConnectionString)
            {
                try
                {
                    RMSGlobal.m_serverConnectionString = sConnectionString;
            ...
            {
                Logger.Write("SQL Command: " + sSqlStatement, LogLevel.Debug, LogSources.DataAccessQuery);
