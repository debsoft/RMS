...
namespace RMS
{
    namespace DataAccess
    {
        public class Database : ADatabase
        {
            ...
            public override ICategoryAncestorDAO CategoryAnchestor
            {
                get { return new CCategoryAncestorDAO(); }
            }

            public override IReportDAO TotalReport
            {
                get { return new CReportDAO(); }
            }

            public override IInventroySalesReportDAO InventorySalesReport
            {
                get { return new InventroySalesReportDAO(); }
            }
