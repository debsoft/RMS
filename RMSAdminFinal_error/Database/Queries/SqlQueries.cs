        ...
        public static string GetQuery(Query eQuery)
        {
            ...
            switch (eQuery)
            {
                ...
                case Query.UpdateCategory3:
                    ...
                    sRetval = " update category3 set cat3_name = '{0}', cat2_id = {1} , description = '{2}', table_price = {3}, tw_price = {4}, bar_price = {5}, status = {6}, cat3_order = {7}, view_table = {8}, view_bar = {9}, view_takeaway = {10},user_id='{12}',datetime={13},food_item_stock_quantity={14} ,unlimited_status={15},selling_in='{16}',vat_included='{17}',vat_Rate={18} where cat3_id = {11} ";                  
                    break;
                ...
                case Query.GetCategory3:
                  //  sRetval = "select cat3_id,cat3_name,cat2_id,description,table_price,tw_price,bar_price,status,cat3_order,view_table,view_bar,view_takeaway,cat3_rank,food_item_stock_quantity,unlimited_status,selling_in from category3 where cat3_id={0}";
                    sRetval = "select cat3_id,cat3_name,cat2_id,description,table_price,tw_price,bar_price,status,cat3_order,view_table,view_bar,view_takeaway,cat3_rank,food_item_stock_quantity,unlimited_status,selling_in,vat_included,vat_Rate from category3 where cat3_id={0}";
