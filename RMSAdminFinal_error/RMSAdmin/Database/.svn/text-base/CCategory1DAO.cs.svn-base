  ...
  public  class CCategory1DAO : BaseDAO, ICategory1DAO
    {
        ...
        public CResult AddCat1(RMS.Common.ObjectModel.CCategory1 inUser)
        {
           CResult oResult = new CResult();
            ...
            try
            {
                ...
                {
                        oResult = this.GetMaxCatOrder(); //New By Baruri at 31.12.2008
                        inUser.Category1Name = inUser.Category1Name.Replace("''", "'");
                        inUser.Category1Name = inUser.Category1Name.Replace("'", "''");

                        this.OpenConnection();
                        string sqlCommand = String.Format(SqlQueries.GetQuery(Query.AddCategory1), inUser.Category1Name, inUser.ParentCatID,inUser.CurrentUserId,inUser.LoginDateTime,(Int32)oResult.Data+1);
        ...
        private CResult GetMaxCatOrder()
        {
            ...
            {
                this.OpenConnection();
                string sSql = SqlQueries.GetQuery(Query.GetMaxCat1Order);
        ...
        private bool CheckCat(CCategory1 inUser)
        {
            ...
            {
                this.OpenConnection();
                string sSql = String.Format(SqlQueries.GetQuery(Query.CheckDupCat1), inUser.Category1Name, inUser.ParentCatID);
        ...
        private bool CheckCatUpdate(CCategory1 inUser)
        {
            ...
            {
                this.OpenConnection();
                string sSql = String.Format(SqlQueries.GetQuery(Query.CheckDupCat1Update), inUser.Category1Name, inUser.ParentCatID, inUser.Category1ID);
