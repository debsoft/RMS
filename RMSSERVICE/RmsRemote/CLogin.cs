...
namespace RmsRemote
{
    public class CLogin : MarshalByRefObject
    {
        ...
        public void PostPrintingRequest2(DataTable inPrintRequest)
        {
            try
            {
        ...
        /// <summary>
        /// This function is used to convert print command to byte array
        /// </summary>
        ...
        public  byte[] ToByteArray(string StringToConvert)
        {
            ...
            for (int indexNumber = 0; indexNumber < CharArray.Length; indexNumber++)
            {
                ByteArray[indexNumber] = Convert.ToByte(Convert.ToInt32(CharArray[indexNumber].ToString()));
            }
            return ByteArray;
        }
